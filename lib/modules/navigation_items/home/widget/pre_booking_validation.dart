...
Future<void> showBookingWithValidation(
  ...
  if (userCtrl.phoneNumber.trim().isEmpty)
    missingProfile.add('phone_number_label'.tr);
  if (userCtrl.employmentStatus.trim().isEmpty)
    missingProfile.add('employment_status_label'.tr);
...
Widget _missingRow(String label, BuildContext context) {
  final isDark = HelperFunctions.isDarkMode(context);
  return Padding(
...
Widget _primaryBtn(String label, VoidCallback onTap, BuildContext context) {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.warning_amber_rounded, color: primary, size: 28),
          ),
          ...
          ...missingFields.map((f) => _missingRow(f, context)),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.badge_outlined, color: primary, size: 28),
          ),
          const SizedBox(height: 16),
          Text(
